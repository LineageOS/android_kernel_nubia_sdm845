...
do_gc:
        ...
        f2fs_warn(sbi, "BG GC count %d.",(sbi)->bg_gc);
...
skip:
    ...
    f2fs_warn(sbi, "GC call count %d.", (sbi->stat_info)->call_count);
    f2fs_warn(sbi, "Try to move %d blocks (BG: %d)\n", (sbi->stat_info)->tot_blks,
				(sbi->stat_info)->bg_data_blks + (sbi->stat_info)->bg_node_blks);
    f2fs_warn(sbi, "  - data blocks : %d (%d)\n", (sbi->stat_info)->data_blks,
				(sbi->stat_info)->bg_data_blks);
	f2fs_warn(sbi, "  - node blocks : %d (%d)\n", (sbi->stat_info)->node_blks,
